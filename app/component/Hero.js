...
const Hero = () => {
  return (
    <>
      <div className="h-full w-full relative text-lg sm:text-8xl">
        ...
        <Link href={"/about"} className="px-8 sm:px-8 sm:py-3 sm:text-[6vh] py-1 bg-cyan-500 text-white rounded-full absolute sm:top-[80vh] top-[70vh] -translate-x-[50%] left-[50%]">Know more</Link>
