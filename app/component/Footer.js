...
export const Footer =()=>{
    return(
        <>
         <div className="flex text-[0.6rem] top-0 mt-11 sm:mt-0 sm:text-xl bg-om w-full h-10 text-slate-400 font-mono items-center relative justify-center mb-5 md:mb-0">
