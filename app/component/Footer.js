...
export const Footer =()=>{
    return(
        <>
         <div className="flex text-[0.6rem] top-0 mt-11 sm:mt-0 sm:text-xl w-full h-10 text-black font-mono items-center relative justify-center mb-5 md:mb-0">
         ...
         <div className="flex">
         <div className="flex-col text-black text-2xl font-mono px-5 sm:px-44">
