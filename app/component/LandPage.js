    ...
    return (
        ...
        <div className="absolute h-full w-full top-0 text-center">
                ...
                <div className="flex items-center justify-center">
                    <Link className="px-3 cursor-pointer py-3 bg-cyan-500 text-white rounded-lg shadow-sm mt-28 mr-5 hover:text-slate-900 hover:-translate-y-1 hover:bg-slate-200 hover:shadow-md duration-300 transition ease-in-out delay-150 font-serif" href="/signup">Join Us Now</Link>
