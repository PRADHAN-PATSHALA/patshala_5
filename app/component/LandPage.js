    ...
    return (
        ...
        <div className="absolute h-full w-full top-[20vh] sm:top-0 text-center">
                ...
                <div className="flex items-center justify-center">
                    <Link className="px-16 cursor-pointer py-3 bg-new2 text-white rounded-3xl hover:rounded-lg shadow-sm mt-28 mr-5 hover:text-black hover:-translate-y-1 hover:bg-white/80 font-sans tracking-normal hover:shadow-md duration-300 transition ease-in-out delay-150" href="/dashbord">Join Us Now</Link>
                    <Link className="px-3 flex cursor-pointer py-3 bg-white/20 text-white rounded-3xl hover:rounded-lg shadow-sm mt-28 hover:bg-white/70 hover:text-black hover:-translate-y-1 hover:shadow-md duration-300 transition ease-in-out delay-150 font-serif" href="#cource">Explore More <BsArrowUpRightCircle className="ml-1 text-xl" /></Link>
                </div>
                </div>
        </>
    );
