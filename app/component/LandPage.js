    ...
    return (
        ...
        <div className="absolute h-full w-full -top-[35vh] sm:top-0 text-center">
                ...
                <div className="flex items-center justify-center">
                    <Link className="px-6 sm:px-16 cursor-pointer py-3 bg-new2 text-white rounded-3xl hover:rounded-lg shadow-sm mt-28 mr-5 hover:text-black hover:-translate-y-1 hover:bg-white/80 font-sans tracking-normal hover:shadow-md duration-300 transition ease-in-out delay-150" href="/dashbord">Join Us Now</Link>
