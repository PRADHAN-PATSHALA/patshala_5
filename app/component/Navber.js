...
export const Navber =()=>{
    return(
        <>
          <nav className="flex px-2 h-[8vh] justify-between sm:h-[9vh] sm:px-6 w-full text-white fixed z-10">
            <div>
             ...
             <ul className="mt-[16px] text-[0.6rem] sm:absolute sm:text-sm flex sm:right-12 top-0 z-20">
